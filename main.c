        ...
        STARTGAME:
            ...
            while (!NextPlayer)
            {
                ...
                else if (STRCOMP(CKata, "SKILL"))
                {
                    ...
                    {
                        puts("Command SKILL tidak bisa digunakan setelah ROLL!!!");
                    }
                }
                ...
                else if (STRCOMP(CKata, "ROLL")) // Kelar Roll atau kelar turn
                {
                    if (!RollUsed)
                    {
                    ...
                    {
                        puts("Command ROLL tidak bisa digunakan setelah ROLL!!!");
                    }
                }
